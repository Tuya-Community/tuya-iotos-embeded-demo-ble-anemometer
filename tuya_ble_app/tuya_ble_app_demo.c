...
static const char auth_key_test[] = "Q9uhgQEAA2XVRqzniL5ksV591r2oFPNZ";
static const char device_id_test[] = "tuyafc0a07c80001";
static const uint8_t mac_test[6] = {0x1D,0x6E,0x31,0x4D,0x23,0xDC}; //The actual MAC address is : 66:55:44:33:22:11 ;DC,23,4D,30,88,A2
...
void app_exe()
{
	...
	if (clock_time_exceed(last_clock, 500000)) { //500ms更新
		last_clock = clock_time();

		lux_adc_init();
		adc_value =  adc_sample_and_get_result();
		anemometer_task(adc_value);
